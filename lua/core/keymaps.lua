...
keymap('n', '<leader>cc', '<cmd>Coverage<CR>', { desc = 'Show coverage' })
keymap('n', '<leader>ct', '<cmd>CoverageToggle<CR>', { desc = 'Coverage Toggle: Show/hide markers' })
...
keymap('n', '<leader>so', ':SymbolsOutline<CR>', { desc = 'Toggle code symbols outline (sidebar)' })

keymap('n', '<leader>q', ':bdelete<CR>', { desc = 'Close current buffer', silent = true })
